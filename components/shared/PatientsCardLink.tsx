...
export default function PatientCardLink({icon:Icon, title,description, href, onClick}: Card) {
  return (
    <Link href={href} className='flex flex-col hover:bg-[#F1F0F0] bg-[#FAFAFA] items-center justify-center p-5'>
      ...
      <div className='flex flex-col items-center justify-center mb-5'>
        <h3 className="text-lg mb-3 text-[1.25rem] text-[#222] font-aeonik font-medium">{title}</h3>
